#!/usr/bin/env python3
"""
snv.py: Single nucleotide variation & indel detection
"""
import argparse
import os
import sys
...
class PipelineManager(PipelineManagerBase):
    def __init__(self, input_files, output, config_file, dryrun):
        ...
        self.name = file_name[:file_name.rfind("_")]
    ...
    def run_bwa(self):
        ...
        self.create_sh("1.BWA", command)
        return self.submit_job("1.BWA")
    ...
    def run_sort(self, dependency_id=None):
        ...
        self.create_sh("2.Sort", command)
        return self.submit_job("2.Sort", dependency_id=dependency_id)
    ...
    def run_mark_duplicates(self, dependency_id=None):
        ...
        self.create_sh("3.MarkDup", command)
        return self.submit_job("3.MarkDup", dependency_id=dependency_id)
    ...
    def run_bqsr(self, dependency_id=None):
        ...
        self.create_sh("4.BQSR", command)
        return self.submit_job("4.BQSR", dependency_id=dependency_id)
    ...
    def run_apply_bqsr(self, dependency_id=None):
        ...
        self.create_sh("5.ApplyBQSR", command)
        return self.submit_job("5.ApplyBQSR", dependency_id=dependency_id)
